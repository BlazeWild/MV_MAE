...
class Config:
    ...
    batch_size = 2
    accumulation_steps = 16  # Simulates a batch size of 32
    num_workers = 8
    prefetch_factor = 3
...
def main():
    ...
    # Passing is_train=True enables Random Spatial Cropping for data augmentation
    ...
    # Passing is_train=False forces Center Cropping for consistent evaluation
