...
DATA_DIR = "datasets/UAVHuman_480p_mp4"
...
# -------------------------------------------------------------------------
# Step 1: Resize and Convert (.avi -> 480p .mp4)
# -------------------------------------------------------------------------
...
def run_conversion():
    ...
    print(f"⚡ Resizing {len(video_files)} videos to 480p .mp4 using {MAX_WORKERS} worker(s)...")
